...
A-H 顺序、CAST azimuth matrix direction 和 Side A offset。MVP-2C 只能读取
overlap-targeted small-slice / depth-resample preview / orientation confidence 等小片段
artifact，不得读取完整 waveform 或 full CAST Zc。MVP-2C 必须比较：
